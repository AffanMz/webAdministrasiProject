							        	...
							        	<div class="row">
							        		<div class="col">
							        			<?php 
														...
														?>
							        			<button type="button" class="btn btn-success button-cus tombolTambahKon" data-bs-toggle="modal" data-bs-target="#exampleModal">
								        		Tambah Data
													  <span class="material-symbols-outlined but-add">
														...
														<div class="dropdown">
														  ...
														  <ul class="dropdown-menu">
														    <li><a class="dropdown-item font-style-2" href="<?= BASEURL; ?>/datadata/excelA/data_diklat">Simpan Excel</a></li>
														    <li><a class="dropdown-item font-style-2" href="<?= BASEURL; ?>/datadata/cetakA/data_diklat">Simpan PDF</a></li>
														  </ul>
														</div>
													<?php } ?>
							        		</div>
							        		<div class="col-4">
							        		<form class="d-flex" role="search" action="<?= BASEURL; ?>/datadata/cariA/data_diklat" method="POST">
									  ...
									  <tbody>
									    ...
									    <tr>
									      ...
									      <td>
											...
											<a href="<?= BASEURL; ?>/datadata/editA/<?= $tag['id_data'] ?>" type="button" class="btn btn-primary minimize tampilModalKon" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="<?=$tag['id_data']; ?>" data-tab="data_diklat">
											  <span class="material-symbols-outlined icon-cus">
												edit
												</span>
											</a>
											<a href="<?= BASEURL; ?>/datadata/hapusA/data_diklat/<?= $tag['id_data'] ?>" class="btn btn-danger minimize" onclick="return confirm('Yakin hapus?');">
											  <span class="material-symbols-outlined icon-cus">
												delete
												</span>
											</a>
											<a href="<?= BASEURL; ?>/datadata/cetakD/data_diklat/<?= $tag['id_data'] ?>" class="btn btn-warning minimize">
											  <span class="material-symbols-outlined icon-cus">
												description
												</span>
											</a>
									  ...
									  <div class="me-auto p-2">
									  	<div class="btn-group btn-group-sm" aria-label="Small button group" role="group">
										    ...
										    <ul class="dropdown-menu width-cus">
										    	<li><a class="dropdown-item" href="<?= BASEURL; ?>/datadata/data_diklat/0">20</a></li>
										      <li><a class="dropdown-item" href="<?= BASEURL; ?>/datadata/data_diklat/0/50">50</a></li>
										      <li><a class="dropdown-item" href="<?= BASEURL; ?>/datadata/data_diklat/0/100">100</a></li>
										      <li><a class="dropdown-item" href="<?= BASEURL; ?>/datadata/data_diklat/0/200">200</a></li>
										    </ul>
										  </div>
									  </div>
									  ...
									  <div class="p-2">
									  	<nav aria-label="Page navigation example">
											  <ul class="pagination cus-pagie">
											    <li class="page-item">
											    	<a class="page-link <?php if ($data['urut'] < $data['tamp']) echo "disabled";?>"  href="<?= BASEURL; ?>/datadata/data_diklat/<?= $data['urut']-$data['tamp']; ?>/<?= $data['tamp']; ?>">
											    		Previous
											    	</a>
											  	</li>
											  	<li class="page-item">
											    	<a class="page-link <?php if ($data['urut'] < $data['tamp']) echo "active";?>" href="<?= BASEURL; ?>/datadata/data_diklat/0/<?= $data['tamp']; ?>">1
											    	</a>
											    </li>
											  	<?php
											  		$awalA = $data['tamp'];
											  	...
											  	?>
											    <li class="page-item">
											    	<a class="page-link <?php if ($awal == $data['urut']) echo "active";?>" href="<?= BASEURL; ?>/datadata/data_diklat/<?= $awal; ?>/<?= $data['tamp']; ?>"><?=$i ?>
											    	</a>
											    </li>
											    <?php 
											    		$awal = $awal+$awalA;
											     ...
											     ?>
											    <li class="page-item">
											    	<a class="page-link <?php if ($data['urut'] == ($awal-$data['tamp'])) echo "disabled";?>" href="<?= BASEURL; ?>/datadata/data_diklat/<?= $data['urut']+$data['tamp']; ?>/<?= $data['tamp']; ?>">Next
											    	</a>
											    </li>
											  </ul>
											</nav>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <input type="hidden" name="view" id="view" value="data_diklat">
      <input type="hidden" name="tab" id="tab" value="data_diklat">
