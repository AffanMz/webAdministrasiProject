													  ...
													  <span class="material-symbols-outlined but-add">
														...
														<div class="dropdown">
														  ...
														  <ul class="dropdown-menu">
														    <li><a class="dropdown-item font-style-2" href="<?= BASEURL; ?>/tagihan/excelA/pelunasan">Simpan Excel</a></li>
														    <li><a class="dropdown-item font-style-2" href="<?= BASEURL; ?>/tagihan/cetakA/pelunasan">Simpan PDF</a></li>
														  </ul>
														</div>
							        		</div>
							        		<div class="col-4">
						        	...
						        	<table class="table table-striped table-hover text-start">
									  <thead class="color-style">
									    ...
									    <div class="row">
									      ...
									      <th scope="col" style="width: 5%;">Job</th>
									  ...
									  <tbody>
									    ...
									    <tr>
									      ...
									      <td>
											...
											<a href="<?= BASEURL; ?>/tagihan/editA/<?= $tag['id_tagihan'] ?>" type="button" class="btn btn-primary minimize tampilModalLunas" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="<?=$tag['id_tagihan']; ?>" data-tab="tagihan_<?= $job ?>">
											  <span class="material-symbols-outlined icon-cus">
												edit
												</span>
											</a>
											<a href="<?= BASEURL; ?>/tagihan/hapusA/<?= $job ?>/<?= $tag['id_tagihan'] ?>" class="btn btn-danger minimize" onclick="return confirm('Yakin hapus?');">
											  <span class="material-symbols-outlined icon-cus">
												delete
												</span>
											</a>
											<a href="<?= BASEURL; ?>/tagihan/cetakD/tagihan_<?= $job ?>/<?= $tag['id_tagihan'] ?>" class="btn btn-warning minimize">
											  <span class="material-symbols-outlined icon-cus">
												description
												</span>
											</a>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <input type="hidden" name="view" id="view" value="pelunasan">
      <input type="hidden" name="tab" id="tab" value="tagihan_<?= $job ?>">
      ...
      <div class="modal-body">
       		...
       		<div class="input-group mb-3">
					...
					<input type="hidden" class="form-control" name="urai" id="urai" placeholder="Uraian">
					<div class="input-group mb-3">
